...
Page({
  ...
  navBtn: function (e) {
    this.setData({
      type: this.data.navList[e.currentTarget.dataset.idx].value
    })
    this.restList()
  },
  restList: function () {
    ...
    util.request(api.incomeList, {
      ...
      if (res.errno == 0) {
        that.setData({
          ...
          inviteIncome: res.data.inviteIncome,
          firstOrderIncome: res.data.firstOrderIncome,
          orderIncome: res.data.orderIncome,
